...
export default function Home() {
  ...
  */
  ...
  const {data:tasksList, isError, isLoading, error, refetch} = useGetTasksQuery();
  ...
  */
  ...
  return (
    <div className="flex flex-col h-screen flex-grow items-center justify-start bg-gray-900 p-4">
      <br />
      <div className="task-app w-full max-w-md rounded-lg bg-gray-800 px-6 pb-2 pt-6 text-gray-200 shadow-lg">
        ...
        <form
          onSubmit={(e) => {
            ...
            addTask(task);
            //refetch(); hnadled at slice logic 
            setNewTask("");
          }}
